...
const makeIngredientCard = (ingredient) => {
  ...
  <div class="card ingredient-card col-3 pt-0 pr-1 pl-1" id="${ingredient.id}-card">
    <div class="card-body text-center pt-2 pb-2">
      ...
      <button class="btn btn-secondary cudButton update-ingredient-button" data-toggle="modal" data-target="#addIngredientModal" id="delete-ingredient-${ingredient.id}"><i class="fas fa-pencil-alt"></i></button>
      </div>
    </div>
  </div>
  `;
